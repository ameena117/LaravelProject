                        ...
                        <ul class="navbar-nav mx-5 mb-2 >
                            <li class="nav-item">
                                <a class="nav-link active border border-left me-3" aria-current="page" href="welcome"
                                    style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color:#061862; font-size: 24px; "><span class="fa fa-home"style="color: #061862;"></span>
                                   الصفحة الرئيسية</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active border border-left me-3" aria-current="page" href="about"
                                    style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color:#061862; font-size: 24px; "><span class="fa fa-info-circle"style="color: #061862;"></span>
                                    
                                    عن المكتبة</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link active border border-left me-3 mx-5" aria-current="page" href="contact"
                                    style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color:#061862; font-size: 24px;"><span class="fa fa-phone"style="color: #061862;"></span>
                                    اتصل بنا</a>
                            </li>
